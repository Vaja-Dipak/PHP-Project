		...
		<div class="container">
			...
			<div class="col-md-3 col-sm-6 footv3-left">
				...
				<ul>
					<li>
						<a href="#">
							<img src="<?php echo $this->assets_url; ?>/images/lt1.jpg" alt="" class="img-responsive">
						</a>
					</li>
					<li>
						<a href="#">
							<img src="<?php echo $this->assets_url; ?>/images/lt4.jpg" alt="" class="img-responsive">
						</a>
					</li>
					<li>
						<a href="#">
							<img src="<?php echo $this->assets_url; ?>/images/lt3.jpg" alt="" class="img-responsive">
						</a>
					</li>
					<li>
						<a href="#">
							<img src="<?php echo $this->assets_url; ?>/images/lt6.jpg" alt="" class="img-responsive">
						</a>
					</li>
					<li>
						<a href="#">
							<img src="<?php echo $this->assets_url; ?>/images/lt5.jpg" alt="" class="img-responsive">
						</a>
					</li>
					<li>
						<a href="#">
							<img src="<?php echo $this->assets_url; ?>/images/lt2.jpg" alt="" class="img-responsive">
						</a>
					</li>
					<li>
						<a href="#">
...
<!-- //home -->
<!-- Common js -->
<script type="text/javascript" src="<?php echo $this->assets_url; ?>/js/jquery-2.2.3.min.js"></script>
<!--// Common js -->
...
<script src="<?php echo $this->assets_url; ?>/js/easy-responsive-tabs.js"></script>
<script>
...
<!-- credit-card -->
<script src="<?php echo $this->assets_url; ?>/js/creditly.js"></script>
<link rel="stylesheet" href="<?php echo $this->assets_url; ?>/css/creditly.css" type="text/css" media="all" />
...
<!-- //dropdown nav -->
<!--search jQuery-->
<script src="<?php echo $this->assets_url; ?>/js/main.js"></script>
<!--search jQuery-->

<!-- Scrolling Nav JavaScript -->
<script src="<?php echo $this->assets_url; ?>/js/scrolling-nav.js"></script>
<!-- //fixed-scroll-nav-js -->
<!--//scripts-->
<!-- //gallery-js  -->
...
<script src="<?php echo $this->assets_url; ?>/js/SmoothScroll.min.js"></script>
<!-- //smooth-scrolling-of-move-up -->
