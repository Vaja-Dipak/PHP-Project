        ...
        <div class="team-row">
            ...
            <div class="col-md-5 team-grid-left">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6 team-grids">
                    <div class="team-effect">
                        <img src="<?php echo $this->assets_url; ?>/images/t3.jpg" alt="img" class="img-responsive">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6 team-grids">
                    ...
                    <div class="team-effect">
                        <img src="<?php echo $this->assets_url; ?>/images/t1.jpg" alt="img" class="img-responsive">
                        <div class="social-icon">
                            <a href="#" class="social-button twitter">
                                <i class="fa fa-brands fa-twitter"></i>
                            </a>
            ...
            <div class="col-md-5 team-grid-right">
                <div class="col-md-6 col-sm-6 col-xs-6 team-grids">
                    ...
                    <div class="team-effect">
                        <img src="<?php echo $this->assets_url; ?>/images/t2.jpg" alt="img" class="img-responsive">
                        <div class="social-icon">
                            <a href="#" class="social-button twitter">
                                <i class="fa fa-brands fa-twitter"></i>
                            </a>
                ...
                <div class="col-md-6 col-sm-6 col-xs-6 team-grids">
                    <div class="team-effect">
                        <img src="<?php echo $this->assets_url; ?>/images/t4.jpg" alt="img" class="img-responsive">
                        <div class="social-icon">
                            <a href="#" class="social-button twitter">
                                <i class="fa fa-brands fa-twitter"></i>
                            </a>
                    ...
                    <div class="row">
                        <div class="col-md-6  testi-main">
                            <div class="testi-grids">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-3  img-testi">
                                    <img class="img-responsive" src="<?php echo $this->assets_url; ?>/images/c3.jpg"
                                        alt="">
                                </div>
                                <div class="clearfix"> </div>
                            </div>
                        ...
                        <div class="col-md-6  testi-main">
                            <div class="testi-grids t2">
                                <div class="col-md-3 col-sm-3 col-xs-3 img-testi">
                                    <img class="img-responsive" src="<?php echo $this->assets_url; ?>/images/c2.jpg"
                                        alt="">
                                </div>
                                <div class="col-md-9 col-sm-9 col-xs-9 team-w3ls-txt">
                                    <h6>Cras rutrum</h6>
                        ...
                        <div class="col-md-6  testi-main">
                            <div class="testi-grids">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-3 img-testi">
                                    <img class="img-responsive" src="<?php echo $this->assets_url; ?>/images/c4.jpg"
                                        alt="">
                                </div>
                                <div class="clearfix"> </div>
                            </div>
                        ...
                        <div class="col-md-6  testi-main">
                            <div class="testi-grids t2">
                                <div class="col-md-3 col-sm-3 col-xs-3 img-testi">
                                    <img class="img-responsive" src="<?php echo $this->assets_url; ?>/images/c1.jpg"
                                        alt="">
                                </div>
                                <div class="col-md-9 col-sm-9 col-xs-9 team-w3ls-txt">
                                    <h6>Cras rutrum</h6>
