...
<div class="single-w3l py-5">
    <div class="container py-xl-5 py-lg-3">
        <div class="row inner_sec_info pt-md-4">
            ...
            <?php
            $card = 0;
            foreach ($facewashdata['Data'] as $key => $value) {
                ?>
                <div class="col-lg-4">
                    <!-- blog grid -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="addcart?productid=<?php echo $value->p_id; ?>"><button type="button" class="btn"
                                            style="width:48%">Add To Cart</button></a>                                    <a href="addcart?productid=<?php echo $value->p_id; ?>"> <button type="button" class="btn" name="btn-addcart?productid=<?php echo $value->p_id; ?>"
