...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Hair Care</li>
...
<div class="single-w3l py-5">
    <div class="container py-xl-5 py-lg-3">
        <div class="row inner_sec_info pt-md-4">
            ...
            <?php
            $card = 0;
            foreach ($shampooConditionerdata['Data'] as $key => $value) {
                ?>
                <div class="col-lg-4">
                    <!-- blog grid -->
                    <div class="full_width_blog_grid">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="addcart?productid=<?php echo $value->p_id; ?>"> <button type="button" class="btn" name="btn-addcart?productid=<?php echo $value->p_id; ?>" style="background: #e83e8c; color:white;width:48%">Buy
                                        Now</button></a>
                                </div>
                            </div>
                        </div>
