    ...
    <div class="col-lg-12 d-flex align-items-stretch">
      <div class="card w-100">
        <div class="card-body p-4">
          <div class="row">
            <h5 class="col-10">Sub Category</h5>
            <div class="col-2 text-right">
              <a class="btn btn-md btn-primary" href="addsubcategory">Add Sub Category</a>
            </div>
            <div class="table-responsive mt-5">
              <table class=" table text-nowrap mb-0 align-middle" style="border: solid 1px;">
                ...
                <tbody>
                  <?php //$index = 1;
                  foreach($allsubcategories['Data'] as $key => $value) {
                    // echo "<pre>";
                    ...
                    <tr>
                      ...
                      <div class="d-flex align-items-center gap-2">
                          <a href="editsubcategory?sc_id=<?php echo $value->sc_id; ?>">
                          ...
                          <a href="deletesubcategory?sc_id=<?php echo $value->sc_id; ?>">
