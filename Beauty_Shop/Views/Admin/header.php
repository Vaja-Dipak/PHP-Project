...
<head>
  ...
  <link rel="stylesheet"
    href="https://cdn.datatables.net/2.0.0/css/jquery.dataTables.min.csshttps://cdn.datatables.net/2.0.0/css/jquery.dataTables.min.css">
      ...
      <div>
        <a href="admindashboard" class="text-nowrap logo-img">
          <div class="brand-logo d-flex align-items-center justify-content-between"
            style="background-color: #ff00f314;">
          ...
          <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                aria-expanded="false">
                <img src="<?php echo $this->base_url; ?>assets/images/profile/user-1.jpg" alt="" width="35" height="35"
