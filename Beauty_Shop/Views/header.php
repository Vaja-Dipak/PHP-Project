...
<html lang="zxx">
	...
	<!-- Custom CSS -->
	<!-- Bootstrap Core CSS -->
	<link href="<?php echo $this->base_url; ?>css/bootstrap.css" rel='stylesheet' type='text/css' />
	<!-- side nav css file -->
	<link href="<?php echo $this->base_url; ?>css/SidebarNav.min.css" media='all' rel='stylesheet' type='text/css' />
	<!-- //side nav css file -->
	<link href="<?php echo $this->base_url; ?>css/style.css" rel='stylesheet' type='text/css' />
	<!-- font-awesome icons -->
	<link href="<?php echo $this->base_url; ?>css/fontawesome-all.min.css" rel="stylesheet">
	<!--webfonts-->
	<link
							...
							<ul class="treeview-menu">
								<li class="treeview">
									...
									<ul class="treeview-menu">
										<li>
											<a href="compact">
												<i class="fa fa-angle-right"></i>Compact powder</a>
										</li>
										<li>
											<a href="foundation">
										...
										<li>
											<a href="lipstick">
												<i class="fa fa-angle-right"></i>Lipstick</a>
										</li>

										<li>
											<a href="eyelinear">
												<i class="fa fa-angle-right"></i>Eyeliner</a>
										</li>
										<li>
											<a href="eyeshadow">
												<i class="fa fa-angle-right"></i>Eyeshadow</a>
										</li>
								...
								<li class="treeview">
									...
									<ul class="treeview-menu">
										<li>
											<a href="facewash">
												<i class="fa fa-angle-right"></i>Face wash</a>
										</li>
										<li>
											<a href="moisturizer">
												<i class="fa fa-angle-right"></i>Moisturizer</a>
										</li>

										<li>
											<a href="sunscreen">
												<i class="fa fa-angle-right"></i>Sunscreen</a>
										</li>
										<li>
											<a href="sheetmask">
