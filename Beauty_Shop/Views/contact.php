...
<head>
    <title>Beauty Blog - Blog Category Flat Bootstrap Responsive Website Template | Contact :: w3layouts</title>
                    ...
                    <div class="mx-auto">
                        ...
                        <div class="row fv3-contact pt-lg-5 pt-3">
                            ...
                            <div class="col-sm-10 mt-sm-0 mt-4">
                                <p>
                                    <a href="mailto:example@email.com" class="text-dark">ABC@example.com</a>
                                </p>
                                <p>
                                    <a href="mailto:example@email.com" class="text-dark">XYZ@example.com</a>
                                </p>
                            </div>
                        </div>
