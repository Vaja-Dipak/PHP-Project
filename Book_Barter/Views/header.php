...
<head>
    <title>Chronicle Book Barter</title>
    ...
    <!-- Custom Theme files -->
    <link href="<?php echo $this->assets_url; ?>/Assets/css/bootstrap.css" type="text/css" rel="stylesheet" media="all">
    <!-- shop css -->
    <link href="<?php echo $this->assets_url; ?>/Assets/css/shop.css" type="text/css" rel="stylesheet" media="all">
    <!-- common-css -->
    ...
    <!-- footer stylesheet -->
    <link href="<?php echo $this->assets_url; ?>/Assets/css/footer3.css" type="text/css" rel="stylesheet" media="all">
    <!-- Range-slider-css -->
    <link rel="stylesheet" type="text/css" href="<?php echo $this->assets_url; ?>/Assets/css/jquery-ui1.css">
    <!-- checkout css -->
    <link href="<?php echo $this->assets_url; ?>/Assets/css/checkout.css" type="text/css" rel="stylesheet" media="all">
    <!-- easy-responsive-tabs css -->
    <link href="<?php echo $this->assets_url; ?>/Assets/css/easy-responsive-tabs.css" type="text/css" media="all"
        rel="stylesheet" />
    <!-- online-fonts -->
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse nav-right">
                        <ul class="nav navbar-nav navbar-left cl-effect-15">
                            ...
                            <li>
                                <a href="login_regi" title="SignIn & SignUp">
