                ...
                <div class="stats-aboutinfo services-main">
                    <div class="agileits_w3layouts-stats-grids text-center">
                        ...
                        <div class="stats-right">
                            <h6>volumes</h6>
                            <div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='221073'
                                data-delay='.5' data-increment="300">221073</div>
                    ...
                    <div class="agileits_w3layouts-stats-grids text-center">
                        ...
                        <div class="stats-right">
                            <h6>branches</h6>
                            <div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='780'
                                data-delay='.5' data-increment="50">980</div>
                    ...
                    <div class="agileits_w3layouts-stats-grids text-center">
                        ...
                        <div class="stats-right">
                            <h6>e-books</h6>
                            <div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='9800'
                                data-delay='.5' data-increment="50">9800</div>
                    ...
                    <div class="agileits_w3layouts-stats-grids text-center">
                        ...
                        <div class="stats-right">
                            <h6>visitors</h6>
                            <div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='123623'
                                data-delay='.5' data-increment="300">123623</div>
                    ...
                    <div class="row">
                        <div class="col-md-6  testi-main">
                            <div class="testi-grids">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-3  img-testi">
                                    <img class="img-responsive" src="<?php echo $this->assets_url; ?>/Assets/images/c3.jpg"
                                        alt="">
                                </div>
                                <div class="clearfix"> </div>
                            </div>
                        ...
                        <div class="col-md-6  testi-main">
                            <div class="testi-grids t2">
                                <div class="col-md-3 col-sm-3 col-xs-3 img-testi">
                                    <img class="img-responsive" src="<?php echo $this->assets_url; ?>/Assets/images/c2.jpg"
                                        alt="">
                                </div>
                                <div class="col-md-9 col-sm-9 col-xs-9 team-w3ls-txt">
                                    <h6>Cras rutrum</h6>
                        ...
                        <div class="col-md-6  testi-main">
                            <div class="testi-grids">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-3 img-testi">
                                    <img class="img-responsive" src="<?php echo $this->assets_url; ?>/Assets/images/c4.jpg"
                                        alt="">
                                </div>
                                <div class="clearfix"> </div>
                            </div>
                        ...
                        <div class="col-md-6  testi-main">
                            <div class="testi-grids t2">
                                <div class="col-md-3 col-sm-3 col-xs-3 img-testi">
                                    <img class="img-responsive" src="<?php echo $this->assets_url; ?>/Assets/images/c1.jpg"
                                        alt="">
                                </div>
                                <div class="col-md-9 col-sm-9 col-xs-9 team-w3ls-txt">
                                    <h6>Cras rutrum</h6>
