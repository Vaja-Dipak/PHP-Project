...
<html
  ...
  <body>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img
                          src="<?php echo $this->assets_url; ?>/Assets/Admin/img/avatars/1.png"
                          alt="user-avatar"
    ...
    <!-- Page JS -->
    <script src="<?php echo $this->assets_url; ?>/Assets/Admin/js/pages-account-settings-account.js"></script>
