							...
							<ul class="slides">
								<li data-thumb="images/s1.jpg">
									<div class="thumb-image">
										<img src="<?php echo $this->assets_url; ?>/Assets/images/lib8.jpg"
											data-imagezoom="true" alt=" " class="img-responsive">
									</div>
								</li>
								<li data-thumb="images/s2.jpg">
									<div class="thumb-image">
										<img src="<?php echo $this->assets_url; ?>/Assets/images/s2.jpg" data-imagezoom="true"
	...
	<!-- //home -->
	<!-- zoom -->
	<script src="<?php echo $this->assets_url; ?>/Assets/js/imagezoom.js"></script>
	<!-- zoom-->
	<!-- single -->
	<!-- FlexSlider -->
	<script src="<?php echo $this->assets_url; ?>/Assets/js/jquery.flexslider.js"></script>
	<script>
